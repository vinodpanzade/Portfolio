  ...
  return (
    <div className="flex justify-between items-center w-full h-20 px-4 text-white bg-black fixed nav">
      <div>
        ...
        <h1 className="text-5xl font-signature ml-2"><a className="link-underline link-underline-black" href="https://vercel.com/vinod-panzades-projects" target="_blank" rel="noreferrer">Vinod</a></h1>
      </div>
